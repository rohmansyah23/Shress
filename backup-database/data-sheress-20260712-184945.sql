...
-- \restrict ahZRGscM9jdkjYccqGkZACNpejlPeUZhYEx1JgfY27J90xhEMu8tI0kw6ooeheA
...
--
-- Data for Name: consignors; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
INSERT INTO "public"."users" ("id", "email", "username", "display_name", "avatar_url", "role", "is_active", "created_at", "updated_at", "password_hash") VALUES
	...
	('8632b4e5-bbfb-4bc6-952e-ea0761f8c1d1', 'test@gmail.com', 'testing', 'tester', NULL, 'staff', true, '2026-07-10 12:39:57.22976+00', '2026-07-11 15:05:39.746525+00', '$2a$06$a563cCgu.rpHY.fbktlNw..b19k/b3bADLH.ppev61LbbOXRaq3Ja'),
...
INSERT INTO "public"."transactions" ("id", "business_id", "category_id", "user_id", "type", "amount", "cogs", "payment_method", "description", "transaction_date", "status_sync", "created_at", "updated_at") OVERRIDING SYSTEM VALUE VALUES
	...
	(111, 3, 20, 'fce2cd2c-13a8-4f22-acd7-e69e74634a13', 'expense', 185000.00, 0.00, 'cash', 'Bayar Ayah', '2026-07-12', true, '2026-07-12 11:32:15.085179+00', '2026-07-12 11:32:15.085179+00');
...
SELECT pg_catalog.setval('"public"."consignment_items_id_seq"', 1, false);


--
-- Name: consignment_settlements_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('"public"."consignment_settlements_id_seq"', 1, false);
...
--
-- Name: consignors_id_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('"public"."consignors_id_seq"', 1, false);
...
SELECT pg_catalog.setval('"public"."debtors_id_seq"', 1, false);
...
SELECT pg_catalog.setval('"public"."user_businesses_id_seq"', 20, true);
...
-- \unrestrict ahZRGscM9jdkjYccqGkZACNpejlPeUZhYEx1JgfY27J90xhEMu8tI0kw6ooeheA
