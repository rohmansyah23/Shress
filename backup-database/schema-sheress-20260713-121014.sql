...
\restrict rL4c2gH5QpR2zmTxvS4A0OUHi4hgQlcS68ySsawz00W6srefVTu6icBgkHqhJTP
...
--
-- Name: check_qty_balance(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.check_qty_balance() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
...
--
-- Name: create_public_user(text, text, text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.create_public_user(p_email text, p_username text, p_role text, p_password text) RETURNS uuid
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
  v_user_id uuid;
...
--
-- Name: update_public_user_password(uuid, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_public_user_password(p_user_id uuid, p_new_password text) RETURNS void
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
BEGIN
  UPDATE public.users
...
--
-- Name: user_has_business_access(integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.user_has_business_access(target_business_id integer) RETURNS boolean
    LANGUAGE sql STABLE SECURITY DEFINER
    SET search_path TO ''
...
--
-- Name: verify_public_password(text, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.verify_public_password(p_identifier text, p_password text) RETURNS uuid
    LANGUAGE sql STABLE
...
CREATE TABLE public.consignment_items (
    ...
    description text,
    CONSTRAINT consignment_items_agreed_price_check CHECK ((agreed_price > (0)::numeric)),
    CONSTRAINT consignment_items_quantity_check CHECK ((quantity > 0)),
    CONSTRAINT consignment_items_quantity_returned_check CHECK ((quantity_returned >= 0)),
    CONSTRAINT consignment_items_quantity_sold_check CHECK ((quantity_sold >= 0))
);
...
ALTER TABLE public.consignment_items ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.consignment_items_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.consignment_settlements (
    ...
    notes text,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT consignment_settlements_amount_check CHECK ((amount > (0)::numeric))
);


--
-- Name: consignment_settlements_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.consignment_settlements ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.consignment_settlements_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.consignments (
    ...
    settled_amount numeric(15,2) DEFAULT 0.00 NOT NULL,
    description text,
    status character varying(20) DEFAULT 'active'::character varying NOT NULL,
    consignment_date date DEFAULT CURRENT_DATE NOT NULL,
    due_date date,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    type character varying(10) DEFAULT 'reseller'::character varying,
    ...
    CONSTRAINT consignments_report_status_check CHECK (((report_status)::text = ANY ((ARRAY['pending'::character varying, 'reported'::character varying, 'settled'::character varying])::text[]))),
    CONSTRAINT consignments_settled_amount_check CHECK ((settled_amount >= (0)::numeric)),
    CONSTRAINT consignments_status_check CHECK (((status)::text = ANY ((ARRAY['active'::character varying, 'settled'::character varying, 'cancelled'::character varying])::text[]))),
    CONSTRAINT consignments_total_amount_check CHECK ((total_amount > (0)::numeric)),
    CONSTRAINT consignments_type_check CHECK (((type)::text = ANY ((ARRAY['reseller'::character varying, 'daily'::character varying])::text[])))
);
...
ALTER TABLE public.consignments ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
...
--
-- Name: consignors; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: consignors_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

ALTER TABLE public.consignors ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.consignors_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE public.debts (
    ...
    CONSTRAINT debts_status_check CHECK (((status)::text = ANY ((ARRAY['unpaid'::character varying, 'partial'::character varying, 'paid'::character varying])::text[])))
);
...
--
-- Name: categories categories_business_name_type_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.categories
    ADD CONSTRAINT categories_business_name_type_unique UNIQUE (business_id, name, type);
...
--
-- Name: consignors consignors_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.consignors
    ADD CONSTRAINT consignors_pkey PRIMARY KEY (id);
...
--
-- Name: idx_consignment_items_consignment; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_consignment_items_consignment ON public.consignment_items USING btree (consignment_id);


--
-- Name: idx_consignment_settlements_consignment; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_consignment_settlements_consignment ON public.consignment_settlements USING btree (consignment_id);


--
-- Name: idx_consignments_business; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_consignments_business ON public.consignments USING btree (business_id);


--
-- Name: idx_consignments_consignor; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_consignments_consignor ON public.consignments USING btree (consignor_id);


--
-- Name: idx_consignments_status; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_consignments_status ON public.consignments USING btree (status);


--
-- Name: idx_consignors_business; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_consignors_business ON public.consignors USING btree (business_id);


--
-- Name: idx_debt_payments_debt; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_debtors_business; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_debtors_business ON public.debtors USING btree (business_id);


--
-- Name: idx_debts_business; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_debts_business ON public.debts USING btree (business_id);
...
--
-- Name: idx_transactions_sync; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_transactions_user_sync; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_user_businesses_business_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: idx_user_businesses_user_id; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: users on_auth_user_update; Type: TRIGGER; Schema: auth; Owner: -
--

CREATE TRIGGER on_auth_user_update AFTER UPDATE OF email ON auth.users FOR EACH ROW EXECUTE FUNCTION public.sync_user_email();
...
--
-- Name: consignments set_consignments_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_consignments_updated_at BEFORE UPDATE ON public.consignments FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: consignors set_consignors_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_consignors_updated_at BEFORE UPDATE ON public.consignors FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: debtors set_debtors_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER set_debtors_updated_at BEFORE UPDATE ON public.debtors FOR EACH ROW EXECUTE FUNCTION public.set_updated_at();


--
-- Name: debts set_debts_updated_at; Type: TRIGGER; Schema: public; Owner: -
--
...
--
-- Name: consignment_items trg_check_qty_balance; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_check_qty_balance BEFORE INSERT OR UPDATE ON public.consignment_items FOR EACH ROW EXECUTE FUNCTION public.check_qty_balance();
...
--
-- Name: consignment_items consignment_items_consignment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.consignment_items
    ADD CONSTRAINT consignment_items_consignment_id_fkey FOREIGN KEY (consignment_id) REFERENCES public.consignments(id) ON DELETE CASCADE;


--
-- Name: consignment_settlements consignment_settlements_consignment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.consignment_settlements
    ADD CONSTRAINT consignment_settlements_consignment_id_fkey FOREIGN KEY (consignment_id) REFERENCES public.consignments(id) ON DELETE CASCADE;


--
-- Name: consignment_settlements consignment_settlements_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.consignment_settlements
    ADD CONSTRAINT consignment_settlements_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;


--
-- Name: consignments consignments_business_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.consignments
    ADD CONSTRAINT consignments_business_id_fkey FOREIGN KEY (business_id) REFERENCES public.businesses(id) ON DELETE CASCADE;


--
-- Name: consignments consignments_consignor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.consignments
    ADD CONSTRAINT consignments_consignor_id_fkey FOREIGN KEY (consignor_id) REFERENCES public.consignors(id) ON DELETE CASCADE;


--
-- Name: consignments consignments_expense_transaction_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.consignments
    ADD CONSTRAINT consignments_expense_transaction_id_fkey FOREIGN KEY (expense_transaction_id) REFERENCES public.transactions(id) ON DELETE SET NULL;


--
-- Name: consignments consignments_income_transaction_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.consignments
    ADD CONSTRAINT consignments_income_transaction_id_fkey FOREIGN KEY (income_transaction_id) REFERENCES public.transactions(id) ON DELETE SET NULL;


--
-- Name: consignments consignments_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.consignments
    ADD CONSTRAINT consignments_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.users(id) ON DELETE CASCADE;


--
-- Name: consignors consignors_business_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.consignors
    ADD CONSTRAINT consignors_business_id_fkey FOREIGN KEY (business_id) REFERENCES public.businesses(id) ON DELETE CASCADE;
...
--
-- Name: debt_payments debt_payments_income_transaction_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.debt_payments
    ADD CONSTRAINT debt_payments_income_transaction_id_fkey FOREIGN KEY (income_transaction_id) REFERENCES public.transactions(id) ON DELETE SET NULL;


--
-- Name: debt_payments debt_payments_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: debtors debtors_business_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.debtors
    ADD CONSTRAINT debtors_business_id_fkey FOREIGN KEY (business_id) REFERENCES public.businesses(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.debts
    ADD CONSTRAINT debts_business_id_fkey FOREIGN KEY (business_id) REFERENCES public.businesses(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.debts
    ADD CONSTRAINT debts_debtor_id_fkey FOREIGN KEY (debtor_id) REFERENCES public.debtors(id) ON DELETE CASCADE;


--
-- Name: debts debts_expense_transaction_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.debts
    ADD CONSTRAINT debts_expense_transaction_id_fkey FOREIGN KEY (expense_transaction_id) REFERENCES public.transactions(id) ON DELETE SET NULL;
...
--
-- Name: businesses anon_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: categories anon_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: consignment_items anon_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY anon_all ON public.consignment_items USING (true) WITH CHECK (true);


--
-- Name: consignment_settlements anon_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY anon_all ON public.consignment_settlements USING (true) WITH CHECK (true);


--
-- Name: consignments anon_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY anon_all ON public.consignments USING (true) WITH CHECK (true);


--
-- Name: consignors anon_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY anon_all ON public.consignors USING (true) WITH CHECK (true);


--
-- Name: debt_payments anon_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY anon_all ON public.debt_payments USING (true) WITH CHECK (true);


--
-- Name: debtors anon_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY anon_all ON public.debtors USING (true) WITH CHECK (true);


--
-- Name: debts anon_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY anon_all ON public.debts USING (true) WITH CHECK (true);


--
-- Name: transactions anon_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: user_businesses anon_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: users anon_all; Type: POLICY; Schema: public; Owner: -
--
...
--
-- Name: consignment_items; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.consignment_items ENABLE ROW LEVEL SECURITY;

--
-- Name: consignment_settlements; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.consignment_settlements ENABLE ROW LEVEL SECURITY;

--
-- Name: consignments; Type: ROW SECURITY; Schema: public; Owner: -
--

ALTER TABLE public.consignments ENABLE ROW LEVEL SECURITY;

--
-- Name: consignors; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: objects Anyone can view QRIS images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Anyone can view QRIS images" ON storage.objects FOR SELECT USING ((bucket_id = 'qris-images'::text));


--
-- Name: objects Users can update QRIS images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Users can update QRIS images" ON storage.objects FOR UPDATE USING ((bucket_id = 'qris-images'::text)) WITH CHECK ((bucket_id = 'qris-images'::text));


--
-- Name: objects Users can upload QRIS images; Type: POLICY; Schema: storage; Owner: -
--

CREATE POLICY "Users can upload QRIS images" ON storage.objects FOR INSERT WITH CHECK ((bucket_id = 'qris-images'::text));
...
--
-- Name: supabase_realtime consignment_items; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.consignment_items;


--
-- Name: supabase_realtime consignments; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.consignments;


--
-- Name: supabase_realtime consignors; Type: PUBLICATION TABLE; Schema: public; Owner: -
--

ALTER PUBLICATION supabase_realtime ADD TABLE ONLY public.consignors;
...
\unrestrict rL4c2gH5QpR2zmTxvS4A0OUHi4hgQlcS68ySsawz00W6srefVTu6icBgkHqhJTP
