...
CREATE OR REPLACE FUNCTION "public"."check_qty_balance"() RETURNS "trigger"
    LANGUAGE "plpgsql"
    AS $$
BEGIN
...
ALTER FUNCTION "public"."check_qty_balance"() OWNER TO "postgres";
...
ALTER TABLE "public"."consignors" OWNER TO "postgres";
...
CREATE OR REPLACE TRIGGER "set_consignments_updated_at" BEFORE UPDATE ON "public"."consignments" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_consignors_updated_at" BEFORE UPDATE ON "public"."consignors" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_debtors_updated_at" BEFORE UPDATE ON "public"."debtors" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();



CREATE OR REPLACE TRIGGER "set_debts_updated_at" BEFORE UPDATE ON "public"."debts" FOR EACH ROW EXECUTE FUNCTION "public"."set_updated_at"();
...
CREATE OR REPLACE TRIGGER "trg_check_qty_balance" BEFORE INSERT OR UPDATE ON "public"."consignment_items" FOR EACH ROW EXECUTE FUNCTION "public"."check_qty_balance"();
